...
<header className="bg-red-600 text-white text-center py-2 font-bold">
  Uso interno – Segreteria Studio CAI
</header>
        <motion.div layout className="bg-white rounded-2xl shadow p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <TextField label="Email" type="operatore" placeholder="nome@operatore.it" value={form.operatore} onChange={(v)=>update("operatore",v)} icon={<Mail className="w-4 h-4"/>} required />
